 ...
 * 
 * A new interpreter_vm struct is created with <interpreter_init>, and will be passed to most
 ...
 *
 * > interpreter_obj *my_func(interpreter_vm *tp)
 * > {
